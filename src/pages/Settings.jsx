...
const ALL_HEALTH_METRICS = [
  ...
  { id: 'workout',   label: 'Workout',          emoji: '🏋️', soon: false },
  { id: 'steps',     label: 'Steps',            emoji: '👟', soon: false },
  { id: 'meditation',label: 'Meditation',       emoji: '🧘‍♀️', soon: false },
  { id: 'weight',    label: 'Body composition', emoji: '⚖️', soon: false },
  { id: 'bpm',       label: 'Heart rate',       emoji: '❤️', soon: false },
  { id: 'bp',        label: 'Blood pressure',   emoji: '🩺', soon: false },
  { id: 'glucose',   label: 'Glucose',          emoji: '🩸', soon: false },
  { id: 'period',    label: 'Period tracker',   emoji: '🌸', soon: false },
  { id: 'medication',label: 'Medication',       emoji: '💊', soon: false },
]
